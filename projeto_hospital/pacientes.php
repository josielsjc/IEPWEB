...
<div class="div_titulo"> <h10> <i class="fas fa-address-card"></i> Pacientes </h10> </div>

Bem vindo a página de cadastro de Paiente!
...
<form method="POST" action="consultas/paciente/sql_cadastrar_pacientes.php"> 
    <div class="row">
        <div class="col-4">
